...
@section('content')
        ...
        <div class="ht__bradcaump__area" style="background: rgba(0, 0, 0, 0) url({{asset("theme/images/bg/2.jpg")}}) no-repeat scroll center center / cover ;">
                            ...
                            <ul class="product__small__images" role="tablist">
                                <li role="presentation" class="pot-small-img active">
                                    <a href="#img-tab-1" role="tab" data-toggle="tab">
                                        <img src="{{asset("theme/images/product-details/small-img/1.jpg")}}" alt="small-image">
                                    </a>
                                </li>
                                <li role="presentation" class="pot-small-img">
                                    <a href="#img-tab-2" role="tab" data-toggle="tab">
                                        <img src="{{asset("theme/images/product-details/small-img/2.jpg")}}" alt="small-image">
                                    </a>
                                </li>
                                <li role="presentation" class="pot-small-img hidden-xs">
                                    <a href="#img-tab-3" role="tab" data-toggle="tab">
                                        <img src="{{asset("theme/images/product-details/small-img/3.jpg")}}" alt="small-image">
                                    </a>
                                </li>
                                <li role="presentation" class="pot-small-img hidden-xs hidden-sm">
                                    <a href="#img-tab-4" role="tab" data-toggle="tab">
                                        <img src="{{asset("theme/images/product-details/small-img/4.jpg")}}" alt="small-image">
                                    </a>
                                </li>
                            </ul>
                            <!-- End Small images -->
                            <div class="product__big__images">
                                <div class="portfolio-full-image tab-content">
                                    <div role="tabpanel" class="tab-pane fade in active product-video-position" id="img-tab-1">
                                        <img src="{{asset("theme/images/product-details/big-img/10.jpg")}}" alt="full-image">
                                    ...
                                    <div role="tabpanel" class="tab-pane fade product-video-position" id="img-tab-2">
                                        <img src="{{asset("theme/images/product-details/big-img/12.jpg")}}" alt="full-image">
                                        <div class="product-video">
                                            <a class="video-popup" href="https://www.youtube.com/watch?v=cDDWvj_q-o8">
                                                <i class="zmdi zmdi-videocam"></i> View Video
                                            </a>
                                    ...
                                    <div role="tabpanel" class="tab-pane fade product-video-position" id="img-tab-3">
                                        <img src="{{asset("theme/images/product-details/big-img/11.jpg")}}" alt="full-image">
                                        <div class="product-video">
                                            <a class="video-popup" href="https://www.youtube.com/watch?v=cDDWvj_q-o8">
                                                <i class="zmdi zmdi-videocam"></i> View Video
                                            </a>
                                ...
                                <div class="review__address__inner">
                                    ...
                                    <div class="pro__review">
                                        <div class="review__thumb">
                                            <img src="{{asset("theme/images/review/1.jpg")}}" alt="review images">
                                        </div>
                                    ...
                                    <div class="pro__review ans">
                                        <div class="review__thumb">
                                            <img src="{{asset("theme/images/review/2.jpg")}}" alt="review images">
                                        </div>
                                        <div class="review__details">
                                            <div class="review__info">
                                                <h4><a href="#">Gerald Barnes</a></h4>
